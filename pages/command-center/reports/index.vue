  ...
  <section class="w-full">
          ...
          <form class="form-inline">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon p0" id="basic-addon2"><button class="btn btn-primaryplain">Search</button></span>
              </div>
            </div>
          </form>
        </div>
    ...
    <table class="text-center w-100">
      ...
      <tbody>
        ...
        >
          <td>
            <a class="btn btn-primary" style="width: 100%;" v-text="report.reportType.name"></a>
          </td>
