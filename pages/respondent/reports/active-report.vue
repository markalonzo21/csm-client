    ...
    <div class="container">
      <div class="active-report">
        <div class="col-md-6">
          ...
          <hr>
          <h4 class="mb-1">
            <span class="bluetext mr20">Report Id:</span>
            {{ report._id }}
          </h4>
          <h4 class="mb-1">
            <span class="bluetext mr20">Type:</span>
            {{ report.reportType.name }}
          </h4>
          <h4 class="mb-1">
            <span class="bluetext mr20">Reported By:</span>
            {{ report.reportedBy.firstName }} {{ report.reportedBy.lastName }} ({{ report.reportedBy.mobile }})
          </h4>
          <h4 class="mb-1">
            <span class="bluetext mr20">Notes:</span>
            {{ report.description }}
          </h4>
        </div>
        <div class="col-md-6">
          ...
          <!-- <tabs class="tabular-view">
            ...
            <tab title="Arrived">
              <div class="panel-body mt20">
                <p
                  class="basic"
                >Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore excepturi veniam voluptatibus eaque dolor enim itaque. Id repellendus voluptate tempora?</p>
