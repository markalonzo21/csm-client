        ...
        <div class="row">
          <div class="col-md-4 left-content">
            ...
            <div class="intro-text mb30">
              <p
                class="basic__dark"
              >This website is an Incident Reporting App and Web Software, wherein you can manage and track incidents in a quick and effective way, inform the right people directly and effortlessly in just one click away</p>
            </div>
            <router-link to="/new-report" class="btn btnblue text-uppercase">Report</router-link>
          </div>
          <div class="col-md-8 right-content">
            <img src="/img/monitor.png" alt class="img-responsive mrgnauto pull-right">
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >This 72-hectare township is envishione to be "the next central busines district in Iloilo.</p>
                </div>
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >With a residential scheme that brings out the spirit of glittering elegance known only to exist for the privileged.</p>
                </div>
                <div class="panel-footer p0">
                  <a href="#" class="btn btnmore pull-right">
                    More
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, quia rem quibusdam veniam minus.</p>
                </div>
                <div class="panel-footer p0">
                  <a href="#" class="btn btnmore pull-right">
                    More
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >Megaworld’s Three Central is an important residential condominium project located on the financial side of Ayala Avenue in Salcedo Village.</p>
                </div>
                <div class="panel-footer p0">
                  <a href="#" class="btn btnmore pull-right">
                    More
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >Megaworld's largest township development in Metro Manila, McKinley Hill.</p>
                </div>
                <div class="panel-footer p0">
                  <a href="#" class="btn btnmore pull-right">
                    More
            ...
            <div class="col-md-4 clrpadding item">
              <div class="panel">
                ...
                <div class="panel-body">
                  ...
                  <p
                    class="basic"
                  >Your security force is your eyes and ears during the busiest times of the day to when the world is asleep and you need a trustworthy sentry to make sure you’re protected.</p>
                </div>
                <div class="panel-footer p0">
                  <a href="#" class="btn btnmore pull-right">
                    More
