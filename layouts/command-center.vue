      ...
      <no-ssr>
        <a-layout class="h-full select-none">
          <div style="width: 200px;">
            <a-layout-sider width="200" style="background: #fff" :style="{ overflow: 'auto', height: '100vh', position: 'fixed', left: 0 }">
              <a-menu
                mode="inline"
                theme="dark"
              ...
              >
                <template v-for="(item, index) in list">
                  <a-menu-item v-if="!item.children" :key="item.link" :class="{ 'ant-menu-item-selected': $route.path === item.link }">
          ...
          <a-layout style="padding: 0 24px 24px">
            <a-breadcrumb style="margin: 16px 0" >
              <a-breadcrumb-item  v-for="(crumb, index) in crumbs">
